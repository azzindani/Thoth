...
| JMA designated-river flood forecasts, r8 (`jma.go.jp/bosai/flood/data/r8/flood_xml.json`) | disasters | candidate | the list is empty when no forecast is in force (2026-09-24); build when one is live to learn the record shape (JMA warnings + volcano levels shipped) |
