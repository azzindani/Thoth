// Collector contract tests, social: radio + lobsters/devto. Consolidated from collectors-batch34/35 (per-collector refactor; batch23 social + batch29/30 gh-events lost with files in Phase 1 — see plan).
// Run: npm run test:collectors (needs thoth_test DB)
import assert from "node:assert/strict";
import { after, before, describe, it } from "node:test";
import { query } from "../src/db/client.js";
import { collect as social } from "../src/workers/collectors/social.js";
