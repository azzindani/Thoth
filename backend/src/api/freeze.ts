...
const NEVER_FROZEN =
	/^(cisa-kev|smithsonian|opensanctions|static|gdacs|swpc-alerts|fema|ioda|ooni|usgs-blast|fng|who-gho|hdx-idmc|fda-food|fda-device|fda-faers|fda-510k|fda-ndc|who-news|state-travel|uk-fcdo|unhcr|submarine-cables|copernicus-ems|calfire|nsw-rfs|vic-emv|ea-floods|mowas|eccc-alerts|qld-fire|wa-dfes|act-esa|katwarn|biwapp|lhp-floods|de-police|reddit|hko-warn|cert-eu|jpcert|who-don|jma-warn|jma-volcano)$/;
const BUDGET: [RegExp, number][] = [
	...
	[/^energy-charts-[a-z]{2}$/, 86400],
	// US Treasury FiscalData: the daily statement posts 1–3 business days late
	// (a long weekend is 5 days); average interest rates are monthly.
	[/^fiscaldata$/, 5 * 86400],
	[/^fiscal-rates$/, 40 * 86400],
	// CERT-FR and the Canadian Cyber Centre publish every business day; a
